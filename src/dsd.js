...
const T = {
  ...
  'png-lab': (a, data) => {
    ...
    const hintList = hints.length
      ...
      : '';
    const gradeBtn = gradeCount ? `<button id="btnGrade" class="btn btn-primary btn-block" disabled title="กรุณารออุปกรณ์บูตให้เสร็จก่อน">${svgIcon('badge-check', 18)} ตรวจคำตอบ (${gradeCount} ข้อ)</button>` : '';
