        ...
        },
        {
          ...
          setupCommands: [
            ...
            { node: 'R2', commands: [
              'configure',
              'set interfaces ethernet eth1 address 10.0.12.2/30',
              'set service dhcp-server shared-network-name LAN subnet 192.168.50.0/24 range R1 start 192.168.50.100 stop 192.168.50.200',
        ...
        },
        {
          ...
          setupCommands: [
            { node: 'R1', commands: [
              ...
              'set vpn ipsec site-to-site peer 10.0.12.2 authentication mode pre-shared-secret',
              'set vpn ipsec site-to-site peer 10.0.12.2 local-address 10.0.12.1',
              'set vpn ipsec site-to-site peer 10.0.12.2 ike-group IKE',
              'set vpn ipsec site-to-site peer 10.0.12.2 default-esp-group ESP',
              'set vpn ipsec site-to-site peer 10.0.12.2 tunnel 1 local prefix 192.168.1.0/24',
              'set vpn ipsec site-to-site peer 10.0.12.2 tunnel 1 remote prefix 192.168.2.0/24',
              'commit',
              'exit',
            ] },
            { node: 'R2', commands: [
              ...
              'set vpn ipsec site-to-site peer 10.0.12.1 authentication mode pre-shared-secret',
              'set vpn ipsec site-to-site peer 10.0.12.1 local-address 10.0.12.2',
              'set vpn ipsec site-to-site peer 10.0.12.1 ike-group IKE',
              'set vpn ipsec site-to-site peer 10.0.12.1 default-esp-group ESP',
              'set vpn ipsec site-to-site peer 10.0.12.1 tunnel 1 local prefix 192.168.2.0/24',
              'set vpn ipsec site-to-site peer 10.0.12.1 tunnel 1 remote prefix 192.168.1.0/24',
              'commit',
              'exit',
            ] },
          ],
